...
import pathlib
import itertools
from typing import NoReturn, Iterator, Callable, List, Dict, Union, Any, Tuple, TypeVar, Type, Optional

import requests

from .weapons import Weapon, Requirements, Damage, Infusions, Infusion, WeaponInfusion, ScalingCoefficients, SaturationCurve, WeaponType
...
class Web:
    @staticmethod
    def _gets(url: str, per_page: int, per_page_limit: int, key: Callable[[dict], int]) -> Iterator[dict]:
...
class Loader:
    ...
    @classmethod
    def load_weapons(cls, *, cache: bool = True, force: bool = False,
                     misc_cache: bool = True, misc_force: bool = False
                     ) -> Iterator[Weapon]:
        weapons = cls._load(
            Cache.load_weapons,
            Cache.save_weapons,
    ...
    def load_misc_data(cls, *, cache: bool = True, force: bool = False):
        return cls._load(
            Cache.load_misc_data,
            Cache.save_misc_data,
            Web.load_misc_data,
            cache,
            force
        )
